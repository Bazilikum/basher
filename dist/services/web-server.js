...
export class WebServer {
    ...
    setupRoutes() {
        ...
        this.app.delete('/api/history', destructiveLimiter, (req, res) => {
            try {
        ...
        this.app.post('/api/terminate/:processId', destructiveLimiter, validateParams(processIdParamSchema), (req, res) => {
            try {
                const processId = parseInt(req.params.processId);
