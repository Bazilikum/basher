 ...
 */
function parseJest(stdout, stderr, exitCode) {
 ...
 */
function parseTypeScript(stdout, stderr, exitCode) {
    const output = stdout + stderr;
    const errors = [];
    const warnings = [];
    const files = [];
 ...
 * Parse ESLint output
 */
function parseESLint(stdout, stderr, exitCode) {
    const output = stdout + stderr;
    const errors = [];
    const warnings = [];
    const files = [];
 ...
 * Parse pytest output
 */
function parsePytest(stdout, stderr, exitCode) {
    const output = stdout + stderr;
    const errors = [];
    const warnings = [];
    const failedTests = [];
 ...
 * Parse JSON output
 */
function parseJson(stdout, stderr, exitCode) {
    const errors = [];
    let parsed = null;
    let valid = false;
    try {
 ...
 */
function parseGeneric(stdout, stderr, exitCode) {
    const output = stdout + stderr;
    const lines = output.split('\n');
    const errors = [];
    const warnings = [];
 ...
 */
function detectParserType(command) {
 ...
 */
export function parseOutput(stdout, stderr, exitCode, parserType = 'auto', command) {
 ...
 */
export function getSmartSummary(stdout, stderr, exitCode, maxLines = 20) {
    const output = stdout + stderr;
    const lines = output.split('\n');
    const errors = [];
    const warnings = [];
 ...
 * Interpret exit code
 */
export function interpretExitCode(exitCode) {
    // Common exit codes
    const exitCodes = {
...
function getSignalName(signalNum) {
    const signals = {
        1: 'SIGHUP',
        2: 'SIGINT',
        3: 'SIGQUIT',
 ...
 */
export function trackProgress(output) {
