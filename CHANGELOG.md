...
### Fixed
- **WebUI template command completion**: Fixed `run_template` not broadcasting `command_executed` event
  - Template commands were stuck showing as "running" in WebUI after completion
  - VS Code extension showed correct status due to direct database polling
