 ...
 */
async function handleGetRecentCommands(
  args: unknown,
  context: ToolContext
): Promise<ToolResult> {
 ...
 */
async function handleGetCommandById(
  args: unknown,
  context: ToolContext
): Promise<ToolResult> {
 ...
 * @deprecated Use handleGetCommand instead
 */
async function handleGetCommandByProcessId(
  args: unknown,
  context: ToolContext
): Promise<ToolResult> {
 ...
 */
async function handleGetCommandStats(
  _args: unknown,
  context: ToolContext
): Promise<ToolResult> {
...
async function handleAdvancedSearch(
  ...
  const results = context.historyManager.advanced.advancedSearch(
    params.query,
    params.limit,
    params.outputLevel,
    params.contextLines,
 ...
 */
async function handleGetLastFailures(
  args: unknown,
  context: ToolContext
): Promise<ToolResult> {
  ...
  const results = context.historyManager.advanced.getLastFailures(
    params.limit,
    params.outputLevel,
    params.since
  );
 ...
 */
async function handleGetSimilarCommands(
  args: unknown,
  context: ToolContext
): Promise<ToolResult> {
  ...
  const results = context.historyManager.advanced.getSimilarCommands(
    params.commandId,
    params.limit,
    params.outputLevel
  );
...
async function handleGetCommandChain(
  ...
  const results = context.historyManager.advanced.getCommandChain(
    params.startId,
    params.maxCommands,
    params.outputLevel
  );
...
async function handleCompareExecutions(
  ...
  const result = context.historyManager.advanced.compareExecutions(
    params.commandId1,
    params.commandId2
  );
